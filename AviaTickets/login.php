        ...
        <fieldset>
          <ol>
            <li class="form-row text-input-row">
              <input type="text" name="name" class="text-input defaultText required email" title="Email"/>
            </li>
            <li class="form-row text-input-row">
              <input type="text" name="password" class="text-input defaultText" title="Password"/>
            </li>
            <li class="button-row">
